...
"border: 10px;")
        ...
        self.memoryTableView = QtWidgets.QTableView(self.memoryLayoutPage)
        self.memoryTableView.setObjectName("memoryTableView")
        self.memoryTableView.verticalHeader().setVisible(True)
        self.verticalLayout_15.addWidget(self.memoryTableView)
