...
"}")
        ...
        self.gridLayout = QtWidgets.QGridLayout(self.mifareSavedTagsButtonContainer)
        ...
        self.mfCloneButton.setMinimumSize(QtCore.QSize(120, 60))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.mfCloneButton.setFont(font)
        self.mfCloneButton.setObjectName("mfCloneButton")
        self.gridLayout.addWidget(self.mfCloneButton, 0, 1, 1, 1)
        self.mfInfoButton = QtWidgets.QPushButton(self.mifareSavedTagsButtonContainer)
        self.mfInfoButton.setMinimumSize(QtCore.QSize(120, 60))
        self.mfInfoButton.setObjectName("mfInfoButton")
        self.gridLayout.addWidget(self.mfInfoButton, 0, 0, 1, 1)
        ...
        self.mfSimulateButton.setMinimumSize(QtCore.QSize(120, 60))
        self.mfSimulateButton.setObjectName("mfSimulateButton")
        self.gridLayout.addWidget(self.mfSimulateButton, 1, 0, 1, 1)
        self.mfDeleteButton = QtWidgets.QPushButton(self.mifareSavedTagsButtonContainer)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.mfDeleteButton.sizePolicy().hasHeightForWidth())
        self.mfDeleteButton.setSizePolicy(sizePolicy)
        self.mfDeleteButton.setMinimumSize(QtCore.QSize(120, 60))
        self.mfDeleteButton.setObjectName("mfDeleteButton")
        self.gridLayout.addWidget(self.mfDeleteButton, 1, 1, 1, 1)
